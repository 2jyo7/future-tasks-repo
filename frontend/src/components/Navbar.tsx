...
const Navbar = () => {
  return (
    <>
  {/* component */}
  <nav className="relative px-4 py-8 flex justify-between items-center  bg-black text-white">
    <Link className="text-3xl font-bold leading-none bg-white" href="#">
    ...
    </Link>ABSTRACT <span>|</span> <span>HELP-CENTER</span>
    ...
    <Link
      className="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6
       bg-purple-500 hover:bg-purple-700 text-sm text-white font-bold shadow-lg  rounded-xl transition duration-200"
      href="#"
    > Submit a request
    </Link>
