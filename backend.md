...
### Backend starting command By Soni Kumari:
-  start the development server: npm run dev;
-  
- Open [http://localhost:3500](http://localhost:3500) with your browser to see the result.

- You can get other endpoints here --
 1. GET call -- "/getHelpCard"
 2. GET call by title -- "/getHelpCardByTitle/:title"
 3. POST call -- "/postHelpCard"
